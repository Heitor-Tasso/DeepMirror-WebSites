...
### Suporte a Lazy Loading mais agressivo
...
### Modo de captura "completa" vs "rápida"
...
### Melhorar Cleaner
**Descrição**: Atualmente o Cleaner pode quebrar os sites e ele não está fazendo uma limpeza que mude muito o tamanho dos arquivos.
**Prioridade**: Média

### Mostrar os Logs do Server mais Detalhados
